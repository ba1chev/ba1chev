...
- [`Chimera-47`](https://github.com/ba1chev/Chimera-47) — Behavioral malware family classifier with three head-to-head models (28 linear SVMs, multinomial softmax, per-class Markov chains) ![Python](https://img.shields.io/badge/-Python-3776AB?logo=python&logoColor=white)
