...
- 🤖 Machine/Deep learning fundamentals and probabilistic modeling
...
- [`Machine-Learning-Algorithms`](https://github.com/ba1chev/Machine-Learning-Algorithms) — Collection of classic ML algorithms (regression, classification, clustering, PCA/LDA, loss functions) implemented from scratch in C++17 ![C++](https://img.shields.io/badge/-C++-00599C?logo=cplusplus&logoColor=white)
